...
that can be useful in application development, such as [Search](http://docs.basho.com/riak/latest/dev/using/search/), [secondary indexes (2i)](http://docs.basho.com/riak/latest/dev/using/2i/), and [Riak
Data Types](http://docs.basho.com/riak/latest/dev/using/data-types/), Riak almost always performs best when you
...
Riak](http://docs.basho.com/riak/latest/dev/using/application-guide/) for a better sense of which features you might need.
...
* The object's key, which can be anything you
  want as long as it is [Unicode compliant](http://www.unicode.org/)
* The [bucket](http://docs.basho.com/riak/latest/theory/concepts/Buckets/) which houses the object and its key (bucket
  names are also Unicode compliant)
* The [bucket type](http://docs.basho.com/riak/latest/dev/advanced/bucket-types/) that determines the bucket's
  [replication](http://docs.basho.com/riak/latest/dev/advanced/replication-properties/) and other properties
...
look like (for the [HTTP API](http://docs.basho.com/riak/latest/dev/references/http/)):
...
One way to determine this is to [list all keys](http://docs.basho.com/riak/latest/dev/references/protocol-buffers/list-keys/) in the
...
A better possibility is to use [Riak sets](http://docs.basho.com/riak/latest/dev/using/data-types/#sets) to
store lists of keys in a bucket. Riak sets are a [Riak Data Type](http://docs.basho.com/riak/latest/theory/concepts/crdts/) that enable you to store lists of binaries or strings in Riak.
...
type](http://docs.basho.com/riak/latest/dev/using/data-types/#setting-up-buckets-to-use-riak-data-types) called
`sets`.
...
Riak [bucket types](http://docs.basho.com/riak/latest/dev/advanced/bucket-types/) have two essential functions:
they enable you to manage [bucket configurations](http://docs.basho.com/riak/latest/theory/concepts/Buckets/) in an
...
that simply extend Riak's [defaults](http://docs.basho.com/riak/latest/dev/advanced/bucket-types/#bucket-types-as-namespaces) or multiple bucket types that have
